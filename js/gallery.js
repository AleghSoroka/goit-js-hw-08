...
function handleModalOpen(event) { 
    ...
    const currentImgSource = event.target.dataset.source;
    
    const currentImgDescription = images
        .find(({ original }) => original === currentImgSource)
        .description;
